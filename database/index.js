...
// const url = `mongodb+srv://${MONGO_ID}:${MONGO_PASSWORD}@cluster0.kafipby.mongodb.net/?retryWrites=true&w=majority`; 천지민 db
const url = `mongodb+srv://${MONGO_ID}:${MONGO_PASSWORD}@cluster0.txxpbd0.mongodb.net/`; // 천준우 db
